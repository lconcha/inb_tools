...
if strcmpi(filename,'matlab_export.vtk')
    ...
    % input line will be sent to operating system. It can not take argument
    % , though. The & at the end of line will return control to Matlab even
    % when the outside process is still running. 
